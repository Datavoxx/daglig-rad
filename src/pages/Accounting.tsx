...
import { BookOpen, Bell, Phone } from "lucide-react";
        ...
        {hasSubmitted ? (
          ...
          <div className="space-y-5">
            <div className="space-y-3">
              ...
              <RadioGroup value={selectedProgram} onValueChange={setSelectedProgram} className="flex flex-wrap gap-4">
            ...
            <Button onClick={handleSubmitInterest} disabled={!phone.trim() || isSubmitting} className="w-full">
