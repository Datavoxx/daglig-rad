        ...
        <TabsList className="w-full justify-start overflow-x-auto scrollbar-hide bg-transparent border-b border-border rounded-none p-0">
          <Tooltip>
            <TooltipTrigger asChild>
              <TabsTrigger value="overview" className="flex items-center gap-1.5 min-w-fit data-[state=active]:bg-primary/10 data-[state=active]:text-primary data-[state=active]:rounded-md data-[state=active]:shadow-[0_0_12px_hsl(142,69%,45%,0.25)] hover:bg-muted/50 py-2 px-3">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <TabsTrigger value="ata" className="flex items-center gap-1.5 min-w-fit data-[state=active]:bg-primary/10 data-[state=active]:text-primary data-[state=active]:rounded-md data-[state=active]:shadow-[0_0_12px_hsl(142,69%,45%,0.25)] hover:bg-muted/50 py-2 px-3">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <TabsTrigger value="workorders" className="flex items-center gap-1.5 min-w-fit data-[state=active]:bg-primary/10 data-[state=active]:text-primary data-[state=active]:rounded-md data-[state=active]:shadow-[0_0_12px_hsl(142,69%,45%,0.25)] hover:bg-muted/50 py-2 px-3">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <TabsTrigger value="files" className="flex items-center gap-1.5 min-w-fit data-[state=active]:bg-primary/10 data-[state=active]:text-primary data-[state=active]:rounded-md data-[state=active]:shadow-[0_0_12px_hsl(142,69%,45%,0.25)] hover:bg-muted/50 py-2 px-3">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <TabsTrigger value="planning" className="flex items-center gap-1.5 min-w-fit data-[state=active]:bg-primary/10 data-[state=active]:text-primary data-[state=active]:rounded-md data-[state=active]:shadow-[0_0_12px_hsl(142,69%,45%,0.25)] hover:bg-muted/50 py-2 px-3">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <TabsTrigger value="diary" className="flex items-center gap-1.5 min-w-fit data-[state=active]:bg-primary/10 data-[state=active]:text-primary data-[state=active]:rounded-md data-[state=active]:shadow-[0_0_12px_hsl(142,69%,45%,0.25)] hover:bg-muted/50 py-2 px-3">
