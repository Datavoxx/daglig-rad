    ...
    <section className="space-y-1.5">
      ...
      >
        <textarea
          ...
          className="w-full min-h-[48px] p-2 text-[13px] leading-relaxed bg-transparent border-0 resize-none focus:outline-none focus:ring-0 placeholder:text-muted-foreground/50"
          rows={2}
        />
      </div>
    </section>
