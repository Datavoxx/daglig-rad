import { FileText, FolderKanban, ClipboardList, Clock, Receipt, MapPin, UserPlus, Pencil, CalendarDays, Wallet } from "lucide-react";
...
const suggestions = [
  ...
  {
    label: "Budget översikt",
    icon: Wallet,
    prompt: "Visa budget översikt för ett projekt",
  },
];
