...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `Du heter Ulla och är en erfaren dokumentationsassistent för svenska byggarbetsplatser. Din uppgift är att analysera ett transkript från en inspektion och matcha det mot en lista med kontrollpunkter.
